...
void fillHistograms(TH2F *h2NcgNppPhi1Bin, TH2F **h2NcgNppPhi2Bin, TH2F **h2NcgNppPhi3Bin, TH2F **h2NcgNppPhi6Bin, TH2F *h2EventPlane, bool reconstruction)
{
   ...
   for (Long64_t jentry = 0; jentry < nentries; jentry++)
   {
      ...
      h2NcgNppPhi1Bin->Fill(_nNetProtonPhi[0]+_nNetProtonPhi[1]+_nNetProtonPhi[2]+_nNetProtonPhi[3]+_nNetProtonPhi[4]+_nNetProtonPhi[5], _nCharged);
...
void netProton(TString inputFile = "inputFile.root", TString outputplotsfolder = "outputFolder/", bool reconstructionRP = false)
{
   ...
   if (!h2NcgNppPhi1Bin)
   {
      h2NcgNppPhi1Bin = new TH2F("h2NcgNppPhi1Bin", "h2NcgNppPhi1Bin", 100, -5.5, 94.5, 100, -0.5, 99.5);
      ...
      for (int i = 0; i < 6; i++)
      {
         if (i < 3)
         {
            if (i < 2)
            {
               h2NcgNppPhi2Bin[i] = new TH2F(Form("h2NcgNppPhi2Bin%d", i), Form("h2NcgNppPhi2Bin%d", i), 100, -5.5, 94.5, 100, -0.5, 99.5);
            ...
            h2NcgNppPhi3Bin[i] = new TH2F(Form("h2NcgNppPhi3Bin%d", i), Form("h2NcgNppPhi3Bin%d", i), 100, -5.5, 94.5, 100, -0.5, 99.5);
         ...
         h2NcgNppPhi6Bin[i] = new TH2F(Form("h2NcgNppPhi6Bin%d", i), Form("h2NcgNppPhi6Bin%d", i), 100, -5.5, 94.5, 100, -0.5, 99.5);
      ...
      h2EventPlane = new TH2F("h2EventPlane", "h2EventPlane", 1000, -1, 1, 100, -0.5, 99.5);
